export default class Canvas{
	...
	*/
	...
	joinRound(){	this.ctx.lineJoin	= "round"; return this; }
	joinBevel(){	this.ctx.lineJoin 	= "bevel"; return this; }
	joinMiter(){	this.ctx.lineJoin	= "miter"; return this; } // default
	capButt(){	    this.ctx.lineCap	= "butt"; return this; }
	capRound(){     this.ctx.lineCap	= "round"; return this; }
	capSquare(){	this.ctx.lineCap	= "square"; return this; }
	...
	*/
	...
	size( w = 500, h = 500 ){
		...
		/* TODO : FIXES BLURRYNESS ON HIGHER DPI SCREENS.
	...
	textCenter( txt, yOffset=0, draw=1 ){
	...
	ellipseVec( v, xRadius = 5, yRadius = 10, draw = 2 ){
		const p2 = Math.PI * 2;
		this.ctx.beginPath();
	...
	lineVecFlatAry( draw, ary, close_loop=false ){
		this.ctx.beginPath();
	...
	triVec( wh, hh, offsetX = 0, offsetY = 0, draw=1 ){
		this.ctx.beginPath();
	...
	updatePX(){ this.ctx.putImageData( this.imageData, 0, 0 ); return this; }
	...
	setPalette( x, y, t, a, b, c, d ){
		const idx = (y*this.width + x) * 4; //RowStart Plus Col Times RGBA component count
	...
	download( fileName='texture.png' ){
		...
		const uri = this.canvas.toDataURL().replace( 'image/png','image/octet-stream' );
